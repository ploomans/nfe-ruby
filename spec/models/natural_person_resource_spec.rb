...
# Unit tests for NfeClient::NaturalPersonResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NaturalPersonResource' do
  before do
    # run before each test
    @instance = NfeClient::NaturalPersonResource.new
  end
  ...
  describe 'test an instance of NaturalPersonResource' do
    it 'should create an instact of NaturalPersonResource' do
      expect(@instance).to be_instance_of(NfeClient::NaturalPersonResource)
    end
  end
