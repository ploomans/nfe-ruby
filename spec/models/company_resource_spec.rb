...
# Unit tests for NfeClient::CompanyResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyResource' do
  before do
    # run before each test
    @instance = NfeClient::CompanyResource.new
  end
  ...
  describe 'test an instance of CompanyResource' do
    it 'should create an instact of CompanyResource' do
      expect(@instance).to be_instance_of(NfeClient::CompanyResource)
    end
  end
  ...
  describe 'test attribute "fiscal_status"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["None", "Active", "CityNotSupported", "Pending", "Inactive"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.fiscal_status = value }.not_to raise_error
       #end
    end
  end
