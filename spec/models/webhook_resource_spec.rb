...
# Unit tests for NfeClient::WebhookResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WebhookResource' do
  before do
    # run before each test
    @instance = NfeClient::WebhookResource.new
  end
  ...
  describe 'test an instance of WebhookResource' do
    it 'should create an instact of WebhookResource' do
      expect(@instance).to be_instance_of(NfeClient::WebhookResource)
    end
  end
