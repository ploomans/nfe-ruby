...
module NfeClient
  ...
  class ServiceInvoiceApproximateTaxesResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalRate')
        self.total_rate = attributes[:'totalRate']
      end
    ...
    def hash
      [source, version, total_rate].hash
    end
