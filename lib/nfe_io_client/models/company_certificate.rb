...
module NfeClient
  ...
  class CompanyCertificate
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["None", "Active", "Overdue", "Pending"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["None", "Active", "Overdue", "Pending"])
    ...
    def hash
      [thumbprint, modified_on, expires_on, status].hash
    end
